...
import { DocumentPermission, DocumentPermissionSchema } from "../documents/document-permission.schema";
...
@Module({
  ...
  providers: [ChatService, EmbeddingService, VectorSearchService],
